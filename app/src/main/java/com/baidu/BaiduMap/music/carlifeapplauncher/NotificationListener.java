...
//        if (task_notification) {
        if (whitelist == null || !whitelist.contains(sbn.getPackageName())) {
            return;
        }
        ...
        bundle.putString("label", Common.loadAppInfo(this,sbn.getPackageName()).label.toString());
        bundle.putString("title", Common.StringFromBundle( sbn.getNotification().extras.getString("android.title")));
        bundle.putString("text", Common.StringFromBundle( sbn.getNotification().extras.getString("android.text")));
